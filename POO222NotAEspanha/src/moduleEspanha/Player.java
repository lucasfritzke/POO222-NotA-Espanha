...
public class Player  extends Person implements Serializable{
	...
	private static ArrayList<String> positionsList = new ArrayList<>(Arrays.asList(
	"Goalkeeper", "Right-back","Centre-back","Forward","Defensive Mid", "Attacking Mid","Winger","Striker"
			)); 	
	...
	public void setNumber(String number) {
		// Caso o usuario passe uma String com letras, não será possivel utilizar o parseInt
